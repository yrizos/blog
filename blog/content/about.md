...
Fast forward to now. Those instincts guide my work at [Epignosis](https://www.epignosishq.com/), where I lead the Architecture Team that shapes the next iteration of [TalentLMS](https://www.talentlms.com/). Modernization without disruption is the ongoing challenge. Every decision is a balance between long-term integrity and short-term needs.

I occasionally [write](/writing/) about what that balance looks like in practice. The trade-offs and small corrections that keep systems on track. The messy reality of team dynamics. The quiet work that keeps things from breaking. For readers with little time, [my optimistic take on AI coding](/writing/the-end-of-coding-as-we-know-it/) is the one to start from.

If you want to get in touch, I'm on [LinkedIn](https://www.linkedin.com/in/yrizos/).
